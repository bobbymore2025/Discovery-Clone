...
export const Shorts=()=>{
    ...
    return(
        <div id="shorts" className="shorts_page">
         <div className="shorts_contents">
           <div className="blk1_category">
             <div className="categories">
              <div>
               <div className="category_heading">
                   <span className="categ_inner">Categories wise</span>
                   </div>
           ...
           <div className="blk2_category">
               <div className="short_videos_blk">
                ...
                <div className="blank_space"><div className=""></div></div>

                <div className="video_content_box">  
                      <div><img style={{width: "100%", height: "100%"}} src="https://i2.wp.com/www.theunbiasedblog.com/wp-content/uploads/2021/06/discovery-Family-Facts-Fun.jpg?fit=800%2C450&ssl=1"></img></div>
                </div>
                        ...
                        <div className="optionals">
                            <div className="style_heart" id="unLike">
                                    <svg width="22px" height="20px" viewBox="0 0 22 20" className="heart_icon" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                        <desc>Created with Sketch.</desc><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <div className="some_gap"></div><div className="some_gap">
                                <div class="style_share" id="share">
                                <div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" className="share_icon" fill="white">
                ...
                <div className="video_content_box">  
                      <div><img style={{width: "100%", height: "460px"}} src="https://cdn.theatlantic.com/thumbor/NAn6iBqudQhgEoL_9om4JFSPiOo=/162x21:1415x961/1200x900/media/img/2013/10/11/innovators-top/original.jpg"></img></div>
                </div>
           ...
           <div className="blk3_category">
               <div className="discov_Ad">
                ...
                <div className="style_textContainer"><div className="textContainer_gapline"></div></div>
                <div className="style_textContainer">
